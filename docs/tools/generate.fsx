...
let website = "/ResolveWarningRepro"

let githubLink = "http://github.com/Update GitHome in build.fsx/ResolveWarningRepro"

// Specify more information about your project
let info =
  [ "project-name", "ResolveWarningRepro"
    "project-author", "Update Author in build.fsx"
    "project-summary", "Project has no summmary; update build.fsx"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/ResolveWarningRepro" ]
